...
function L0_1(A0_2)
  ...
  L10_2 = spritemanager
  L10_2 = L10_2.getStructuresSheet
  L10_2 = L10_2()
  L11_2 = spritemanager
  L11_2 = L11_2.getStructuresSheetImage
  L12_2 = "Buildings_smalloven"
  L11_2 = L11_2(L12_2)
  L12_2 = 60
  L13_2 = 60
    ...
    if L1_3 == "began" then
      function L1_3(A0_4)
        ...
        if L1_4 == "clicked" then
          ...
          L3_4 = vTable
          L3_4 = L3_4.secondaryGameName
          if L3_4 == "Reverse" then
            L2_4 = "http://georiot.co/1BM0"
            L3_4 = ANDROID
            if L3_4 == true then
              L2_4 = "http://www.pixelcubestudios.com/MoreGames.html"
            end
            L3_4 = KINDLE
            if L3_4 == true then
              L2_4 = "http://www.pixelcubestudios.com/MoreGames.html"
          ...
          if L5_4 == false then
            ...
            L6_4 = {}
            L6_4.service = L3_4
            L7_4 = "I found a hidden structure in "
            L8_4 = L1_4
            L9_4 = "! AWESOME!"
            L7_4 = L7_4 .. L8_4 .. L9_4
            L6_4.message = L7_4
